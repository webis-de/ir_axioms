...
if is_pyterrier_installed():
    ...
    from axioms.axiom import Axiom, EstimatorAxiom, ORACLE
    from axioms.axiom.estimator import ScikitLearnEstimator, ScikitLearnEstimatorAxiom
    from axioms.integrations.pyterrier.utils import (
        inject_pyterrier,
        require_columns,
        load_documents,
        load_queries,
    )
    from axioms.integrations.pyterrier.transformers import KwikSortReranker
    from axioms.model import JudgedRankedDocument, Document, JudgedDocument, Query
    from axioms.tools import PivotSelection, RandomPivotSelection
