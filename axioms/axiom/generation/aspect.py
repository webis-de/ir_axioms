...
class AspectCoverageAxiom(Axiom[GenerationInput, GenerationOutput]):
    ...
    def preference(
        ...
        input_aspects = set(self.aspect_extraction.extract_aspects(input.text))
        ...
        output1_aspects = (self.aspect_extraction.extract_aspects(output1.text),)
        output2_aspects = (self.aspect_extraction.extract_aspects(output2.text),)
