...
@option("--offline/--online", default=False, envvar="AXIOMS_OFFLINE")
@pass_context
...
def version(cli_options: CliOptions) -> None:
    ...
    echo(f"{axioms_version} ({', '.join(other_versions)})")
...
def preferences(cli_options: CliOptions, run_path: Path,
    ...
    if not started():
        ...
        import axioms.utils.nltk
        axioms.utils.nltk.offline = cli_options.offline
