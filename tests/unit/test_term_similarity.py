...
def test_stmc1():
    ...
    document1 = RankedTextDocument("d1", 2, 1, "blue auto goes through the city")
    document2 = RankedTextDocument("d2", 1, 2, "red airplane flies in the sky")
...
def test_stmc2_equal():
    ...
    document1 = RankedTextDocument("d1", 3, 1, "dog fire orange")
    document2 = RankedTextDocument("d2", 2, 2, "dog animal animal animal time key")
    document3 = RankedTextDocument("d3", 1, 3, "dog animal time key")
